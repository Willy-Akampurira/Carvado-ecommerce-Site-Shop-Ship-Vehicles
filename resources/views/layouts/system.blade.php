    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div>
        <h3 class="text-lg font-semibold mb-2">
          <i class="fa-solid fa-location-dot mr-2 text-red-500"></i> Location
        </h3>
      ...
      <div>
        <h3 class="text-lg font-semibold mb-2">
          <i class="fa-solid fa-link mr-2 text-red-500"></i> Quick Links
        </h3>
        <ul class="space-y-1">
      ...
      <div>
        <h3 class="text-lg font-semibold mb-2">
          <i class="fa-solid fa-file-contract mr-2 text-red-500"></i> Legal
        </h3>
        <ul class="space-y-1">
      ...
      <div class="text-center md:text-left">
        ...
        <h3 class="text-lg font-semibold mb-2">
          <i class="fa-solid fa-envelope-open-text mr-2 text-red-500"></i> Subscribe to News
        </h3>
        ...
        <h3 class="text-lg font-semibold mt-6 mb-2">
          <i class="fa-solid fa-credit-card mr-2 text-red-500"></i> We Accept
        </h3>
